...
//Name: f14tomcat.ma
//Last modified: Sun, Sep 18, 2016 05:14:51 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.192865461308303 5.3969411615151195 5.9955760013756638 ;
	setAttr ".r" -type "double3" 3216.861647247993 -93.400000000008234 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1E02B89A-F046-8A0E-706F-779A001463F2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 12.029475971511255;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 17 ".pt";
	setAttr ".pt[10]" -type "float3" 0 0 -0.078893617 ;
	setAttr ".pt[25]" -type "float3" 0 0 -0.0024398933 ;
	setAttr ".pt[30]" -type "float3" 0 0 0.028808048 ;
	setAttr ".pt[73]" -type "float3" 0 -0.0088167693 0 ;
	setAttr ".pt[77]" -type "float3" 0 -0.078836344 0 ;
	setAttr ".pt[78]" -type "float3" 0 -0.080879457 0 ;
	setAttr ".pt[102]" -type "float3" 0.006272166 0 0 ;
	setAttr ".pt[104]" -type "float3" -0.067822568 0 0 ;
	setAttr ".pt[117]" -type "float3" 0 -0.042848401 0.022844711 ;
	setAttr ".pt[118]" -type "float3" 0 -0.06895183 0 ;
	setAttr ".pt[123]" -type "float3" -0.030981969 0 0 ;
	setAttr ".pt[124]" -type "float3" 0 -0.02936567 0 ;
	setAttr ".pt[125]" -type "float3" 0 -0.038052954 0.018012041 ;
	setAttr ".pt[143]" -type "float3" 0 -0.027855631 0 ;
	setAttr ".pt[153]" -type "float3" 0 -0.039103325 0 ;
	setAttr ".pt[154]" -type "float3" 0.0095982775 0 0 ;

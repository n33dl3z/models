...
//Name: f14tomcat.ma
//Last modified: Sun, Sep 18, 2016 05:43:13 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.8219346567147596 5.9435921324074652 29.621561369170411 ;
	setAttr ".r" -type "double3" 3588.2616472329746 367.79999999984136 -2.0064103041274709e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1E02B89A-F046-8A0E-706F-779A001463F2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 26.693175657300742;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.53177046775817871 0.625 ;
	...
	setAttr -s 19 ".pt";
	setAttr ".pt[21]" -type "float3" 0 0.0053500761 -0.0009913817 ;
	...
	setAttr ".pt[103]" -type "float3" 0 0.024462182 0.011819913 ;

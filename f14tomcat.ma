...
//Name: f14tomcat.ma
//Last modified: Sun, Sep 18, 2016 06:43:00 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.5370915405422281 3.473690580614941 17.814288265882709 ;
	setAttr ".r" -type "double3" 4311.8616471570831 378.59999999857632 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1E02B89A-F046-8A0E-706F-779A001463F2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 19.869879405042152;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.53177046775817871 0.5 ;
	...
	setAttr -s 82 ".pt";
	setAttr ".pt[2]" -type "float3" 0 -0.082272232 0 ;
	setAttr ".pt[3]" -type "float3" 0.06335669 0.071927235 0 ;
	setAttr ".pt[4]" -type "float3" 0 -0.05551869 0 ;
	setAttr ".pt[5]" -type "float3" 0 0.11544868 0 ;
	setAttr ".pt[6]" -type "float3" 0 0.016032539 0 ;
	setAttr ".pt[9]" -type "float3" -0.044109803 0 0 ;
	setAttr ".pt[10]" -type "float3" -0.040437002 -0.052914947 0.027833806 ;
	setAttr ".pt[15]" -type "float3" 0 0.046682749 0 ;
	setAttr ".pt[17]" -type "float3" 0 -0.065573946 0 ;
	setAttr ".pt[18]" -type "float3" 0 0.021965571 0 ;
	setAttr ".pt[20]" -type "float3" 0.063767098 0.07027261 0 ;
	setAttr ".pt[21]" -type "float3" 0 -0.082272232 0 ;
	setAttr ".pt[24]" -type "float3" -0.10379311 -0.051133953 0 ;
	setAttr ".pt[31]" -type "float3" 0.037974734 0 0 ;
	setAttr ".pt[38]" -type "float3" -0.076470926 -0.054480471 0 ;
	setAttr ".pt[40]" -type "float3" -0.056073003 0 0 ;
	setAttr ".pt[46]" -type "float3" -0.076470926 -0.054480471 0 ;
	setAttr ".pt[48]" -type "float3" 0 0.048583005 0 ;
	setAttr ".pt[52]" -type "float3" -0.07510291 0.051195513 0 ;
	setAttr ".pt[54]" -type "float3" 0 -0.069364712 0 ;
	setAttr ".pt[55]" -type "float3" -0.033131693 -0.058691829 0.036331512 ;
	setAttr ".pt[56]" -type "float3" -0.11873535 -0.14491367 0 ;
	setAttr ".pt[57]" -type "float3" -0.081043743 -0.11630379 0 ;
	setAttr ".pt[58]" -type "float3" -0.21779875 -0.06065695 0.11892025 ;
	setAttr ".pt[59]" -type "float3" -0.016542172 0.038912393 0 ;
	setAttr ".pt[61]" -type "float3" 0 -0.024995605 0 ;
	setAttr ".pt[62]" -type "float3" 0 -0.029231455 0.050386477 ;
	setAttr ".pt[66]" -type "float3" 0.012467664 0 0 ;
	setAttr ".pt[69]" -type "float3" -0.067744389 0 0 ;
	setAttr ".pt[74]" -type "float3" -0.012512153 -0.10910762 0.045491751 ;
	setAttr ".pt[75]" -type "float3" -0.012481876 -0.10978594 0 ;
	setAttr ".pt[78]" -type "float3" -0.013637147 0 0 ;
	setAttr ".pt[79]" -type "float3" -0.053259287 0 0 ;
	setAttr ".pt[80]" -type "float3" -0.071164049 0.033065099 0 ;
	setAttr ".pt[81]" -type "float3" -0.071164049 0 0 ;
	setAttr ".pt[82]" -type "float3" -0.07510291 0 0 ;
	setAttr ".pt[83]" -type "float3" -0.082966097 -0.023220869 0 ;
	setAttr ".pt[92]" -type "float3" 0 0.050406802 0 ;
	setAttr ".pt[93]" -type "float3" 0 0.038912393 0 ;
	setAttr ".pt[94]" -type "float3" 0 0.016938649 0 ;
	setAttr ".pt[95]" -type "float3" 0.0096289469 0.014853254 0 ;
	setAttr ".pt[96]" -type "float3" 0 0.053017814 0 ;
	setAttr ".pt[97]" -type "float3" 0 0.062673301 0 ;
	setAttr ".pt[99]" -type "float3" 0 -0.028428789 0 ;
	setAttr ".pt[100]" -type "float3" 0 -0.018315982 0 ;
	setAttr ".pt[101]" -type "float3" 0 -0.061444353 -0.1187503 ;
	setAttr ".pt[102]" -type "float3" 0 -0.079601042 0 ;
	setAttr ".pt[103]" -type "float3" 0 -0.082272232 0 ;
	setAttr ".pt[104]" -type "float3" 0 -0.082272232 0 ;
	setAttr ".pt[105]" -type "float3" 0 -0.10451623 0 ;
	setAttr ".pt[106]" -type "float3" 0 -0.012471225 0 ;
	setAttr ".pt[107]" -type "float3" 0 0 0.051549297 ;
	setAttr ".pt[108]" -type "float3" 0 0 0.02792548 ;
	setAttr ".pt[112]" -type "float3" 0 -0.064800993 0.0020253116 ;
	setAttr ".pt[113]" -type "float3" 0 -0.045914058 0 ;
	setAttr ".pt[114]" -type "float3" -0.14129937 0 0 ;
	setAttr ".pt[120]" -type "float3" -0.031352803 -0.072031625 0 ;
	setAttr ".pt[121]" -type "float3" 0 -0.038181517 0 ;
	setAttr ".pt[123]" -type "float3" -0.020242982 0 0 ;
	setAttr ".pt[124]" -type "float3" -0.013805256 -0.13514769 0 ;
	setAttr ".pt[125]" -type "float3" -0.21092607 -0.10702022 -0.21654472 ;
	setAttr ".pt[126]" -type "float3" 0 0.038912393 0 ;
	setAttr ".pt[135]" -type "float3" -0.097968072 -0.1613573 0 ;
	setAttr ".pt[136]" -type "float3" -0.082966097 -0.014236363 0 ;
	setAttr ".pt[137]" -type "float3" -0.07510291 0 0 ;
	setAttr ".pt[138]" -type "float3" -0.071164049 0 0 ;
	setAttr ".pt[139]" -type "float3" -0.071164049 0.024115037 0 ;
	setAttr ".pt[145]" -type "float3" -0.12502198 0.093991518 0.10363846 ;
	setAttr ".pt[146]" -type "float3" -0.12502198 0.093991518 0.10363846 ;
	setAttr ".pt[149]" -type "float3" -0.047923617 -0.042188492 0 ;
	setAttr ".pt[150]" -type "float3" -0.060391285 0 0 ;
	setAttr ".pt[151]" -type "float3" -0.047923617 -0.042188492 0 ;
	setAttr ".pt[152]" -type "float3" -0.060391285 0 0 ;
	setAttr ".pt[153]" -type "float3" -0.087328665 0.034094192 0.03355898 ;
	setAttr ".pt[154]" -type "float3" -0.087328665 0 0 ;
	setAttr ".pt[155]" -type "float3" -0.060786761 -0.044060919 -0.084646121 ;
	setAttr ".pt[168]" -type "float3" 0 0.066719964 0 ;
	setAttr ".pt[169]" -type "float3" 0 0.066719964 0 ;

...
//Name: f14tomcat.ma
//Last modified: Sun, Sep 18, 2016 04:38:25 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.353836756259042 3.469968667202378 6.7146403397634558 ;
	setAttr ".r" -type "double3" 2505.2616472556711 -1020.6000000001064 -1.562031390297145e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1E02B89A-F046-8A0E-706F-779A001463F2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 13.63952662416224;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 99 ".pt";
	setAttr ".pt[2]" -type "float3" 0 0.0054529328 -0.57172 ;
	...
	setAttr ".pt[10]" -type "float3" -0.10158326 -0.021911478 0 ;
	...
	setAttr ".pt[21]" -type "float3" 0 -0.017722096 0.24902943 ;
	setAttr ".pt[24]" -type "float3" -0.062234819 -0.097969085 -0.064666197 ;
	...
	setAttr ".pt[36]" -type "float3" -0.069438815 0 0 ;
	...
	setAttr ".pt[69]" -type "float3" 0 0.015775697 -0.49418467 ;
	setAttr ".pt[70]" -type "float3" -0.13888432 0.20172647 0 ;
	setAttr ".pt[72]" -type "float3" 0 -0.080150433 0 ;
	...
	setAttr ".pt[87]" -type "float3" -0.051503122 0.1183854 0.0018554757 ;
	setAttr ".pt[88]" -type "float3" -0.09260232 0 0 ;
	setAttr ".pt[89]" -type "float3" -0.044873986 0 0 ;
	setAttr ".pt[90]" -type "float3" -0.14739195 -0.06911134 -0.20922223 ;
	...
	setAttr ".pt[101]" -type "float3" -0.13106281 -0.027498866 0 ;
	setAttr ".pt[102]" -type "float3" -0.10073855 -0.025395861 0 ;
	setAttr ".pt[103]" -type "float3" -0.058660418 -0.0088049863 0 ;
	setAttr ".pt[104]" -type "float3" -0.075207435 0 0 ;
	setAttr ".pt[106]" -type "float3" -0.30367139 0 0 ;
	setAttr ".pt[107]" -type "float3" -0.16919255 0 0 ;
	...
	setAttr ".pt[121]" -type "float3" -0.01477831 -0.043117188 0.25774199 ;
	setAttr ".pt[122]" -type "float3" -0.018796848 -0.028463097 -0.55512989 ;
	setAttr ".pt[123]" -type "float3" 0 0.12286875 0 ;
	...
	setAttr ".pt[135]" -type "float3" -0.14080855 0 0 ;
	setAttr ".pt[136]" -type "float3" -0.1405499 0.071806751 0 ;
	setAttr ".pt[137]" -type "float3" -0.091245137 0 0 ;
	setAttr ".pt[138]" -type "float3" -0.041688446 0 0 ;
	setAttr ".pt[139]" -type "float3" -0.097274974 0 0 ;
	setAttr ".pt[140]" -type "float3" -0.13732558 0.091414556 0 ;
	setAttr ".pt[141]" -type "float3" -0.080761835 -0.037751641 -0.23317577 ;
	setAttr ".pt[142]" -type "float3" -0.068185158 -0.073719211 -0.359799 ;
	...
	setAttr ".pt[154]" -type "float3" -0.011359948 0.097645849 0 ;
	setAttr ".pt[155]" -type "float3" -0.048249893 -0.0054463008 -0.10303232 ;
	setAttr ".pt[156]" -type "float3" -0.0739142 -0.10144707 -0.031689715 ;

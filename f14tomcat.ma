...
//Name: f14tomcat.ma
//Last modified: Sun, Sep 18, 2016 07:05:32 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.8744605141229655 -16.001596270099274 -40.323379330916332 ;
	setAttr ".r" -type "double3" 4841.6616471799689 730.99999999923034 2.0250525957602429e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1E02B89A-F046-8A0E-706F-779A001463F2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 43.077329260049567;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.92765265689704091 -2.4482659882957822 -0.1849866810127152 ;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.625 0.70990508794784546 ;
...
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.61249977350234985 0.61600172519683838 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 22 ".pt";
	setAttr ".pt[0]" -type "float3" -0.037102759 0.0043488191 -0.18856268 ;
	setAttr ".pt[1]" -type "float3" -0.034335401 0.012817513 -0.1822091 ;
	setAttr ".pt[2]" -type "float3" -0.029504532 0.017200818 -0.17813507 ;
	setAttr ".pt[3]" -type "float3" -0.023051035 0.018909551 -0.17559047 ;
	setAttr ".pt[4]" -type "float3" -0.013938988 0.020070337 -0.17493075 ;
	setAttr ".pt[5]" -type "float3" -0.004400393 0.018988475 -0.17574485 ;
	setAttr ".pt[6]" -type "float3" 0.0029850572 0.016532997 -0.17828208 ;
	setAttr ".pt[7]" -type "float3" 0.0088509861 0.0095258346 -0.18323447 ;
	setAttr ".pt[8]" -type "float3" 0.0099478187 0.0042914655 -0.18831272 ;
	setAttr ".pt[9]" -type "float3" 0.010372665 -0.0014759363 -0.19409427 ;
	setAttr ".pt[10]" -type "float3" 0.0086828098 -0.0072066691 -0.19990794 ;
	setAttr ".pt[11]" -type "float3" 0.0066215247 -0.012396386 -0.20530859 ;
	setAttr ".pt[12]" -type "float3" 0.0035040132 -0.01822944 -0.20969903 ;
	setAttr ".pt[13]" -type "float3" -0.0066484567 -0.019159226 -0.21218006 ;
	setAttr ".pt[14]" -type "float3" -0.014849742 -0.020070329 -0.21310586 ;
	setAttr ".pt[15]" -type "float3" -0.023051025 -0.019159226 -0.21218002 ;
	setAttr ".pt[16]" -type "float3" -0.029407224 -0.01786704 -0.20957112 ;
	setAttr ".pt[17]" -type "float3" -0.03390469 -0.013880552 -0.20478094 ;
	setAttr ".pt[18]" -type "float3" -0.03633647 -0.0068377685 -0.19827776 ;
	setAttr ".pt[19]" -type "float3" -0.037151299 -0.0013830676 -0.19449902 ;
	setAttr ".pt[40]" -type "float3" 0.090820171 0.32620674 0.0035498533 ;
createNode transform -n "pCylinder2";
	rename -uid "5196460A-46C1-C632-A1F1-63A218E75660";
	setAttr ".t" -type "double3" 0.81909881653124117 -2.3169532802961088 1.6270954625603258 ;
	setAttr ".r" -type "double3" 85.864366548957705 -3.4302642677294743 -0.028024175987667991 ;
...
createNode mesh -n "pCylinderShape2" -p "pCylinder2";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 62 ".pt";
	setAttr ".pt[0]" -type "float3" -0.67762268 0.021556808 0.14854181 ;
	setAttr ".pt[1]" -type "float3" -0.58047277 0.021556808 0.33920917 ;
	setAttr ".pt[2]" -type "float3" -0.42915812 0.021556808 0.4905239 ;
	setAttr ".pt[3]" -type "float3" -0.23849061 0.021556808 0.58767372 ;
	setAttr ".pt[4]" -type "float3" -0.027134242 0.021556808 0.62114912 ;
	setAttr ".pt[5]" -type "float3" 0.18422213 0.021556808 0.58767366 ;
	setAttr ".pt[6]" -type "float3" 0.3748894 0.021556808 0.49052379 ;
	setAttr ".pt[7]" -type "float3" 0.52620399 0.021556808 0.33920908 ;
	setAttr ".pt[8]" -type "float3" 0.62335372 0.021556808 0.14854172 ;
	setAttr ".pt[9]" -type "float3" 0.65682918 0.021556808 -0.062814593 ;
	setAttr ".pt[10]" -type "float3" 0.62335372 0.021556808 -0.27417085 ;
	setAttr ".pt[11]" -type "float3" 0.52620393 0.021556808 -0.46483821 ;
	setAttr ".pt[12]" -type "float3" 0.37488937 0.021556808 -0.61615282 ;
	setAttr ".pt[13]" -type "float3" 0.18422204 0.021556808 -0.71330267 ;
	setAttr ".pt[14]" -type "float3" -0.027134242 0.021556808 -0.74677807 ;
	setAttr ".pt[15]" -type "float3" -0.23849043 0.021556808 -0.71330261 ;
	setAttr ".pt[16]" -type "float3" -0.42915782 0.021556808 -0.61615276 ;
	setAttr ".pt[17]" -type "float3" -0.58047253 0.021556808 -0.46483818 ;
	setAttr ".pt[18]" -type "float3" -0.67762232 0.021556808 -0.27417079 ;
	setAttr ".pt[19]" -type "float3" -0.71109772 0.021556808 -0.062814593 ;
	...
	setAttr ".pt[40]" -type "float3" -0.027134182 0.021556808 -0.062814474 ;
	setAttr ".pt[41]" -type "float3" 0.086895972 -0.2207703 -0.1066156 ;
	setAttr ".pt[82]" -type "float3" 0.11950886 8.197798e-011 -2.132637e-008 ;
	setAttr ".pt[83]" -type "float3" 0.11365969 8.197798e-011 0.036930259 ;
	setAttr ".pt[84]" -type "float3" 0.096684702 8.197798e-011 0.070245534 ;
	setAttr ".pt[85]" -type "float3" 0.070245557 8.197798e-011 0.096684702 ;
	setAttr ".pt[86]" -type "float3" 0.036930267 8.197798e-011 0.11365972 ;
	setAttr ".pt[87]" -type "float3" -1.4318332e-008 8.197798e-011 0.11950887 ;
	setAttr ".pt[88]" -type "float3" -0.0369303 8.197798e-011 0.11365972 ;
	setAttr ".pt[89]" -type "float3" -0.070245609 8.197798e-011 0.096684717 ;
	setAttr ".pt[90]" -type "float3" -0.096684784 8.197798e-011 0.070245557 ;
	setAttr ".pt[91]" -type "float3" -0.11365975 8.197798e-011 0.036930267 ;
	setAttr ".pt[92]" -type "float3" -0.11950886 8.197798e-011 -2.132637e-008 ;
	setAttr ".pt[93]" -type "float3" -0.11365966 8.197798e-011 -0.036930285 ;
	setAttr ".pt[94]" -type "float3" -0.096684702 8.197798e-011 -0.070245571 ;
	setAttr ".pt[95]" -type "float3" -0.070245557 8.197798e-011 -0.096684709 ;
	setAttr ".pt[96]" -type "float3" -0.03693027 8.197798e-011 -0.11365972 ;
	setAttr ".pt[97]" -type "float3" -1.0756692e-008 8.197798e-011 -0.11950887 ;
	setAttr ".pt[98]" -type "float3" 0.036930259 8.197798e-011 -0.11365972 ;
	setAttr ".pt[99]" -type "float3" 0.070245534 8.197798e-011 -0.096684717 ;
	setAttr ".pt[100]" -type "float3" 0.096684694 8.197798e-011 -0.070245571 ;
	setAttr ".pt[101]" -type "float3" 0.11365969 8.197798e-011 -0.036930293 ;
